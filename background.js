		...
		contains: [
			...
			},
			{
				...
				variants: [
					{
						// KLM
						begin: /(KL   [0-9])|(KL  [0-9]{2})|(KL [0-9]{3})|(KL[0-9]{4})/
					},
					{
						// AF
						begin: /(AF   [0-9])|(AF  [0-9]{2})|(AF [0-9]{3})|(AF[0-9]{4})/
					},
					{
						// DELTA
						begin: /(DL   [0-9])|(DL  [0-9]{2})|(DL [0-9]{3})|(DL[0-9]{4})/
					}
				]
			},
			{
				className: 'flight-partner',
				begin: /([A-Z]{2}   [0-9])|([A-Z]{2}  [0-9]{2})|([A-Z]{2} [0-9]{3})|([A-Z]{2}[0-9]{4})/
			},
			{
				className: 'time',
				variants: [
